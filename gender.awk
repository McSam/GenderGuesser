#Download from http://lawker.googlecode.com/svn/fridge/lib/awk/gender.awk

#Scott Pakin. http://lawker.googlecode.com/svn/fridge/share/pdf/pakin1991.pdf Regular 
#Expressions and Gender Guessing. In Computer Language Magazine, 8(12):pp. 59-68, December 1991.
...
/^.*an$/                                  { sex = "m" }  # Logan, Brogan...
/^[MDR][io]cky$/                          { sex = "m" }  # Ricky, Micky, Dicky, Rocky...
                                          { printf "%s", sex }  # Output prediction
